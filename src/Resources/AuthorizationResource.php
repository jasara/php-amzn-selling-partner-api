...
class AuthorizationResource implements ResourceContract
{
     ...
     */
    public function getAuthorizationCodeFromMwsToken(string $seller_id, string $developer_id, string $mws_auth_token): GetAuthorizationCodeResponse|ErrorListResponse
    {
        $response = $this->http
